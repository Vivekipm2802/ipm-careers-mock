...
export default function QuestionBrowser  ({sideBarActive,setSidebarActive,gamestate,questions,report,switchQuestion}){
    ...
    <div className='flex flex-row relative items-center justify-start flex-wrap'>
      {questions && questions.map((i,d)=>{
        return <div className='p-1 relative group' onClick={()=>{switchQuestion(i.id)}}>
