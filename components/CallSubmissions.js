...
const query = supabase2.from('predictor').select("*")
setSelected([])
...
if(bo == false){
  ...
  const headers = [
    ...
    { label: "VA Marks", key: "va" },
    { label: "SA Marks", key: "sa" },
    { label: "QA Marks", key: "qa" }
  
  ]

    return <div className={styles.main}>
        <Head><meta name="robots" content="noindex" /></Head>
        <h1 className={styles.heading + " !text-2xl font-bold text-left "}>Call Predictor Submissions</h1>
...
export default CallSubmissions;