...
const query = supabase2.from('admit_cards').select("id,created_at,name,phone,email,location,pluscode,map_url,url,category,appno,location")
setSelected([])
...
if(bo == false){
  ...
  const headers = [
    ...
    return <div className={styles.main}>
        ...
        <h1 className={styles.heading + " !text-lg font-bold text-left "}>Admit Card Tool Submissions</h1>
