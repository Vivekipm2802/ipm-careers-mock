...
export default function AdaptivePlan({ userData }) {
  ...
  return (
    <div className="w-full flex flex-col overflow-y-auto pr-0 md:pr-4" style={{ color: "var(--c-text-primary)", textAlign: "left" }}>
      ...
      {/* Week strip: restored owner-preferred timeline design (dots on a line,
          Sep 2026) — the tall day-rows card from the redesign sprint was never
          approved on screen; it also collapsed inside the flex column. */}
      <div className="max-w-[860px] relative mt-6 mb-2" style={{ flexShrink: 0 }} data-tour="plan-week">
